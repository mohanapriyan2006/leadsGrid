...
export const PRICING_PLANS: Record<PricingPlanKey, PricingPlanDefinition> = {
  single_free: {
    ...
    compactHighlights: [
      "Storage: 100 leads",
      "Leads Discovery: 2 times/day",
      "Email Sending: 5 times/day",
      "Ask AI: 100 times/month",
      "Agent AI: 30 times/month",
    ],
    fullHighlights: [
  ...
  single_pro: {
    ...
    compactHighlights: [
      "Storage: 5,000 leads",
      "Leads Discovery: 75 times/day",
      "Email Sending: 300 times/day",
      "Ask AI: 2,500 times/month",
  ...
  single_max: {
    ...
    compactHighlights: [
      ...
      "Leads Discovery: 250 times/day",
      "Email Sending: 1,500 times/day",
      "Ask AI: 10,000 times/month",
  ...
  org_normal: {
    ...
    compactHighlights: [
      ...
      "Leads Discovery: 800 times/day",
      "Email Sending: 3,000 times/day",
      "Ask AI: 20,000 times/month",
    ],
    fullHighlights: [
  ...
  org_pro: {
    ...
    compactHighlights: [
      "Users: up to 20",
      "Storage: Unlimited (fair usage)",
      "Leads Discovery: 3,000 times/day",
      "Email Sending: 12,000 times/day",
