  ...
  return (
    <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
      <article className="glass-card-sm p-4">
        <p className="text-xs uppercase tracking-[0.18em]  text-content-tertiaryy">Expected Revenue</p>
      ...
      <article className="glass-card-sm p-4">
        <p className="text-xs uppercase tracking-[0.18em]  text-content-tertiaryy">Likely to Close</p>
      ...
      <article className="glass-card-sm p-4">
        <p className="text-xs uppercase tracking-[0.18em]  text-content-tertiaryy">Deals at Risk</p>
      ...
      <article className="glass-card-sm p-4">
        <p className="text-xs uppercase tracking-[0.18em]  text-content-tertiaryy">Confidence Score</p>
