              ...
              <div className="relative h-[450px] [perspective:2000px]">
                ...
                >
                  ...
                  >
                    ...
                    <div className="mt-5 rounded-glass-sm border border-accent/15 bg-surface/30 px-3 py-2 text-center text-[11px] font-semibold uppercase tracking-[0.1em]  ">
                  ...
                  <div className="absolute inset-0 rounded-2xl border border-accent/30 bg-surface-secondary/90 p-6 shadow-[0_0_36px_rgba(99,102,241,0.25)] [backface-visibility:hidden] [transform:rotateY(180deg)]">
                    <p className="mb-2 text-[11px] uppercase tracking-[0.12em]  ">Full plan details</p>
                    ...
                    {plan.fairUsage ? (
                      <p className="mt-2 text-center text-[11px]  ">Fair usage policy applies.</p>
                    ) : null}
