  ...
  return (
    <section className="glass-card-sm p-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.5fr_1fr_1fr]">
        <div>
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-content-tertiary">Sources</p>
        ...
        <div>
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-content-tertiary">Minimum Score</p>
        ...
        <div>
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-content-tertiary">Industry</p>
          <select
